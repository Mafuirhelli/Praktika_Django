...
urlpatterns = [
    ...
    re_path(r'^publisher/create/$', views.PublisherCreate.as_view(), name='publisher_create'),
    re_path(r'^publisher/(?P<pk>\d+)/update/$', views.PublisherUpdate.as_view(), name='publisher_update'),
    re_path(r'^publisher/(?P<pk>\d+)/delete/$', views.PublisherDelete.as_view(), name='publisher_delete'),
